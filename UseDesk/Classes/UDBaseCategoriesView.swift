...
class UDBaseCategoriesView: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    ...
    private func firstState() {
        ...
        navigationItem.title = baseCollection?.title ?? "Категория"
